          ...
          {showDropdown1 ? (
            <div className="flex flex-col justify-start items-center mb-4 px-4 border-b border-gray-600 w-full  ">
              ...
              <div className="flex justify-start  flex-col w-full md:w-auto items-start pb-1 ">
                <Link href="/produits/papeterie" className="flex justify-start items-center space-x-6 hover:text-white focus:bg-[#050219] focus:text-white hover:bg-[#050219] text-gray-800 rounded px-3 py-2  w-full md:w-52">
                ...
                <Link href="/produits/plv" className="flex justify-start items-center space-x-6 hover:text-white focus:bg-[#050219] focus:text-white hover:bg-[#050219] text-gray-800 rounded px-3 py-2  w-full md:w-52">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <Link href="/produits/packaging" className="flex justify-start items-center space-x-6 hover:text-white focus:bg-[#050219] focus:text-white hover:bg-[#050219] text-gray-800 rounded px-3 py-2 w-full md:w-52">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <Link href="/produits/goodies" className="flex justify-start items-center space-x-6 hover:text-white focus:bg-[#050219] focus:text-white hover:bg-[#050219] text-gray-800 rounded px-3 py-2  w-full md:w-52">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
